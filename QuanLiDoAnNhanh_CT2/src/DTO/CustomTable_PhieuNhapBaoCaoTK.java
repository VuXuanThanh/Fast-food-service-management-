 ...
 */
public class CustomTable_PhieuNhapBaoCaoTK extends AbstractTableModel
{
    //Khai báo xâu chứa tiêu đề của bảng.
    private String name[]={"Số phiếu","Ngày nhập","Tổng tiền",
   };
    //Khai báo lớp Chứa kiểu dữ liệu của từng trường tương ứng.
    private Class classes[]={String.class,Date.class,Integer.class,Double.class,
    };
    //Tạo một đối tượng arrayList có tên listThiSinh.
    ArrayList<PhieuNhap> dsThiSinh=new ArrayList<>();

    //phương thức khởi tạo cho class có tham số truyền vào.
    public CustomTable_PhieuNhapBaoCaoTK(ArrayList<PhieuNhap> listPTB2)
   {
