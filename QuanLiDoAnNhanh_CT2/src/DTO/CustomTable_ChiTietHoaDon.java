 ...
 */
public class CustomTable_ChiTietHoaDon extends AbstractTableModel
{
    //Khai báo xâu chứa tiêu đề của bảng.
    private String name[]={"Mã món","Tên món","Số lượng","Giá","Thành tiền"};
    //Khai báo lớp Chứa kiểu dữ liệu của từng trường tương ứng.
    private Class classes[]={Integer.class,String.class,Integer.class,Double.class,Double.class};
    //Tạo một đối tượng arrayList có tên listThiSinh.
    ArrayList<ChiTietHoaDon> dsThiSinh=new ArrayList<>();

    //phương thức khởi tạo cho class có tham số truyền vào.
    public CustomTable_ChiTietHoaDon(ArrayList<ChiTietHoaDon> listPTB2)
   {
    ...
    public Object getValueAt(int rowIndex,int columnIndex)
    {
        ...
        switch(columnIndex)
        {
            ...
            //Cột b
            case 2: return dsThiSinh.get(rowIndex).getSoLuong();
            //cột c
            case 3: return dsThiSinh.get(rowIndex).getDoAn().getGia();
            //cột kq
            case 4: return dsThiSinh.get(rowIndex).thanhTien();
