 ...
 */
public class CustomTable_HoaDon extends AbstractTableModel
{
    //Khai báo xâu chứa tiêu đề của bảng.
    private String name[]={"Mã hóa đơn","Mã nhân viên","Khách hàng","Ngày xuất","Thời gian","Tổng tiền"};
    ...
    public CustomTable_HoaDon(ArrayList<HoaDon> listPTB2)
   {
    ...
    public Object getValueAt(int rowIndex,int columnIndex)
    {
        switch(columnIndex)
        {
            ...
            //cột kq
            case 4: return dsThiSinh.get(rowIndex).getThoiGian();
            
            case 5: return dsThiSinh.get(rowIndex).getTongTien();
