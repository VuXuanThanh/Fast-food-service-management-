 ...
 */
public class CustomTableNCC extends AbstractTableModel
{
    //Khai báo xâu chứa tiêu đề của bảng.
    private String name[]={"Mã nhà cung cấp","Tên nhà cung cấp","Địa chỉ","Số điện thoại"};
    //Khai báo lớp Chứa kiểu dữ liệu của từng trường tương ứng.
    private Class classes[]={Integer.class,String.class,String.class, String.class};
    //Tạo một đối tượng arrayList có tên listThiSinh.
    ArrayList<NhaCungCap> dsThiSinh=new ArrayList<>();

    //phương thức khởi tạo cho class có tham số truyền vào.
    public CustomTableNCC(ArrayList<NhaCungCap> listPTB2)
   {
    ...
    public Object getValueAt(int rowIndex,int columnIndex)
    {
        ...
        {
            //Cột số a
            case 0: return dsThiSinh.get(rowIndex).getMaNCC();
            //Cột b
            case 1: return dsThiSinh.get(rowIndex).getTenNCC();
            //cột c
            case 2: return dsThiSinh.get(rowIndex).getDiaChi();
            
             case 3: return dsThiSinh.get(rowIndex).getSoDT();
            //cột kq
